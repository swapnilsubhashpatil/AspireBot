    ...
    if (firstName && lastName && emailAddress && password) {
      try {
        const response = await axios.post(
          "https://aspirebot.onrender.com/createAccount",
          {
            firstName,
            lastName,
            emailAddress,
        ...
        if (response.status === 201) {
          toast.success(
            "Account Created Successfully! Welcome to Cryptopulse!",
            {
              position: "top-right",
              autoClose: 5000,
        ...
        if (error.response?.status === 400) {
          ...
          toast.error(
            "Oops! We couldn’t create your account. An error occurred.",
            {
              position: "top-right",
              autoClose: 5000,
              hideProgressBar: false,
        ...
        <div className={Style.loginDivMain}>
          ...
          <div className={Style.loginDiv1}>
            <div className={Style.loginContentDiv1}>
              <h1 className={Style.loginContentDivHeading}>
                Create your account
              </h1>
              <p className={Style.loginContentDivPara}>
                Welcome to AspireBot: Your Path to Success
              </p>
              ...
              <div className={Style.loginBtnDiv}>
                <button className={Style.loginBtn} onClick={createAccount}>
                  Create Account
                </button>
              </div>
